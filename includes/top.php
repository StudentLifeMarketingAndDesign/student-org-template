        ...
        <div class="wrapper">
            <div class="division-directory clearfix">
                <div class="dosl-wrapper clearfix">
                    <a href="http://studentlife.uiowa.edu/" class="dosl">
                        <img src="division-bar/images/division-bar/dosl-logo.png" alt="Division of Student Life"></a>
                    <p class="adr">
                    ...
                    <li class="has-subnav">
                        ...
                        <div class="division-show-hide">
                            <ul class="menu-list">
                                ...
                                <li>
                                    <a href="http://csil.uiowa.edu/">Center for Student Involvement &amp; Leadership</a>
                                </li>
                                <li>
                                    <a href="http://www.uiowa.edu/ucs/">Counseling Service</a>
                                </li>
                                <li>
                                    <a href="http://dos.uiowa.edu/">Dean of Students</a>
                                </li>
                            </ul>
                            <ul class="menu-list">
                                <li>
                                    <a href="http://housing.uiowa.edu/">Housing & Dining</a>
                                </li>
                                <li>
                                    <a href="http://imu.uiowa.edu/">Iowa Memorial Union</a>
                                </li>
                                <li>
                                    <a href="http://pickone.uiowa.edu">Pick One</a>
                                </li>
                                <li>
                                    <a href="http://recserv.uiowa.edu/Apps/Default.aspx">Recreational Services</a>
                                </li>
                            </ul>
                            <ul class="menu-list">
                                <li>
                                    <a href="http://www.uiowa.edu/sds/">Student Disability Services</a>
                                </li>
                                <li>
                                    <a href="http://studenthealth.uiowa.edu/">Student Health &amp; Wellness</a>
                                </li>
                                <li>
                                    <a href="http://wrac.uiowa.edu/">Women&rsquo;s Resource &amp; Action Center</a>
                                </li>
                                <li>
                                    <a href="http://studentlife.uiowa.edu/about/rocklin/">Vice President for Student Life</a>
                                </li>
                            </ul>
                        </div>
                    </li>
            ...
            <div class="clearfix">
                ...
                <a href="#" class="directory-toggle">
                    <img src="division-bar/images/division-bar/division_studentlife.png" alt="Division of Student Life" width="224"></a>
            </div>
        </div>
    </div>