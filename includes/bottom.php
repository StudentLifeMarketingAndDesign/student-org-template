  ...
  <div class="row">
    <div class="large-12 columns">
      <div class="colgroup">
          ...
          <div class="col-1-4 hide-print">
            <div class="colgroup">
              <ul class="footer-nav">
                ...
                <li>
                  <a href="$SiteConfig.FacebookLink" target="_blank"> <i class="icon-facebook"></i>
                    Facebook
                  </a>
                </li>
                <li>
                  <a href="$SiteConfig.TwitterLink" target="_blank"> <i class="icon-twitter"></i>
                    Twitter
                  </a>
                </li>
              </ul>
        ...
        <p>
          &copy; 2014
          <a href="http://www.uiowa.edu/" target="_blank">The University of Iowa</a>
          . All Rights Reserved.
        </p>
      </div>
    </div>
