    ...
    <div class="large-12 large-centered columns">
      ...
      <div class="row">
        <div class="medium-7 columns">
          ...
          <ul>
            <li><a href="#">National Chapter</a></li>
            <li><a href="#">Sailing 101: A Guide For Beginners</a></li>
        ...
        <div class="medium-5 columns">
          ...
          <!--site creators have an option to show FB, Twitter, or site news posts here. -->
