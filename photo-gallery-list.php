			...
			<div class="large-12 columns">
				...
				<div id="galleries-list">
					<ul class="small-block-grid-2 large-block-grid-4 block-list">
						...
						<li>
							<a class="cover-image fi-thumbnails th" href="gallery.php" style="background-image: url('images/examples/colortest3.jpg')"><h3>Photo Gallery Title</h3><img src="images/examples/colortest3.jpg" alt="slide 1" /></a>
						</li>
						<li>
							<a class="cover-image fi-thumbnails th" href="gallery.php" style="background-image: url('images/examples/colortest4.png')"><h3>Photo Gallery Title</h3><img src="images/examples/colortest4.png" alt="slide 1" /></a>
						</li>
					</ul>
