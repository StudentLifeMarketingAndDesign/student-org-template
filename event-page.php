...
if(isset($_GET['image']) && ($image = $_GET['image'])){
	...
	$image = 'images/examples/news-example'.$randomImage.'.jpg';
}
?>
		...
		<div class="row article-container">
			...
			<div class="large-8 article-text columns">
				<ul class="breadcrumbs">
					...
					<li><a href="index.php#events" class="home">Events</a></li>
					<li class="current"><a href="#">Fair Day!!</a></li>
				</ul>
				...
				<img src="images/examples/colortest8.jpg" />
				...
				<section class="row">
					<div class="large-12 columns">
						...
						<ul class="small-block-grid-1 medium-block-grid-2 large-block-grid-2 block-list">
							<li>
								<a class="cover-image" href="event-page.php" style="background-image: url('images/examples/colortest10.jpg')"></a>
								<article>
								<h2><a href="event-page.php">Fair Day!!</a></h2><span>Feb 21 @ 9:30am <br /> Iowa Memorial Union</span>
								</article>
							</li>
							<li>
								<a class="cover-image" href="event-page.php" style="background-image: url('images/examples/colortest9.jpg')"></a>
								<article>
								<h2><a href="event-page.php">River Rafting</a></h2><span>Feb 21 @ 12:00pm <br /> Iowa River</span>
								</article>
							</li>
							<li>
								<a class="cover-image" href="event-page.php" style="background-image: url('images/examples/colortest8.jpg')"></a>
								<article>
				...
				<section class="row">
					<div class="large-12 columns">
						...
						<ul id="news-list" class="block-list small-block-grid-1 medium-block-grid-2 large-block-grid-2">
							...
							<li>
								<article>
								<h3><a href="news-page.php">Best Music to listen to while knitting (and sailing)</a></h3><span> Feb 21</span>
								</article>
							</li>
						</ul>
